...
| `signal_v_aspect3_left.svg` / `_right` | <img src="switchboard-component/src/main/resources/icons/signals/sbb_l/signal_v_aspect3_left.svg" width="32" height="32"> | SBB distant (Vorsignal) shape (Swiss/German) — top-left orange + both green lights lit (aspect 3) |
