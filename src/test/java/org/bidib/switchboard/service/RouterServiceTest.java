...
class RouterServiceTest {
    ...
    void bfsAlternativeRoutesFindsAlternativesWithExhaustiveMode() throws Exception {
        ...
        org.bidib.switchboard.model.RailwayModel model = new org.bidib.switchboard.model.RailwayModel();
        org.bidib.switchboard.view.SwitchboardPanel panel = new org.bidib.switchboard.view.SwitchboardPanel(model);
        org.bidib.switchboard.persistence.LayoutPersistence.load(panel, path);
        ...
        org.bidib.switchboard.model.Route r = panel.getRouteModel().getRoute(routeId);
    ...
    void bfsAlternativeRoutesWithExhaustiveFindsMultipleForP015ToTL004() throws Exception {
        ...
        org.bidib.switchboard.model.RailwayModel model = new org.bidib.switchboard.model.RailwayModel();
        org.bidib.switchboard.view.SwitchboardPanel panel = new org.bidib.switchboard.view.SwitchboardPanel(model);
        org.bidib.switchboard.persistence.LayoutPersistence.load(panel, layoutPath);
