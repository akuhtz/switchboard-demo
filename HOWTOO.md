...
- **Alternative routes**: When a route is created, BFS also finds up to 2 alternative paths (by excluding the primary route tiles and re-running). Right-click any route tile to see them in the context menu:
